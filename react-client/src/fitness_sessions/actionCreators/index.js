...
import {
  ...
  UPDATE_SESSION_START_TIME, SAVE_SESSION_FAILED,
}
from '../actions';
...
export function saveSession() {
    return (dispatch, getState) => {
        ...
        const startTime = getSessionStartTime(getState()).format("h:mm aa");
        const endTime = getSessionEndTime(getState()).format("h:mm aa");
